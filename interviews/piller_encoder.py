...
class PillarFeatureNet(nn.Module):
    ...
    def preprocess(self, features, num_points, coors, *args, **kwargs):
        """Forward function.
    ...
    def forward(self, features, num_points=None, coors=None, *args, **kwargs):
        
        if self.with_preprocess:
            features = self.preprocess(features, num_points, coors)
